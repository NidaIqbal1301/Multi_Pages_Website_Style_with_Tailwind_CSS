            ...
            <div className="swiper-wrapper">
              <div className="swiper-slide">
                <div className="card">
                  ...
                  <div className="card_body">
                    <h3 className="card_title">The north coat</h3>
                    <p className="card_price">$120</p>
              ...
              <div className="swiper-slide">
                <div className="card">
                  ...
                  <div className="card_body">
                    <h3 className="card_title">RGB liquid CPU Cooler</h3>
                    <p className="card_price">$120</p>
                    <div className="card_ratings">
                      <div className="card_stars">
                        <svg
              ...
              <div className="swiper-slide">
                <div className="card">
                  ...
                  <div className="card_body">
                    <h3 className="card_title">Gucci duffle bag</h3>
                    <p className="card_price">$120</p>
                    <div className="card_ratings">
                      <div className="card_stars">
                        <svg
              ...
              <div className="swiper-slide">
                <div className="card">
                  ...
                  <div className="card_body">
                    <h3 className="card_title">Small BookSelf</h3>
                    <p className="card_price">$120</p>
                    <div className="card_ratings">
                      <div className="card_stars">
                        <svg
